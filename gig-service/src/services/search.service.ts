...
import { elasticSearchClient } from '@gig-service/elasticsearch';
import { IHitsTotal, IPaginateProps, IQueryList, ISearchResult } from '@sidharrrthnix/ms-shared-package';
