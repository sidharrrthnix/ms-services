import { IOrderMessage, IRatingTypes, IReviewMessageDetails, ISellerDocument } from '@sidharrrthnix/ms-shared-package';
import { SellerModel } from '@user-service/models/seller.schema';
