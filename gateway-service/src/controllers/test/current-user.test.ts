import * as auth from '@auth-service/services/auth.service';
import * as helper from '@sidharrrthnix/ms-shared-package';
...
jest.mock('@auth-service/services/auth.service');
jest.mock('@auth-service/queues/auth.producer');
jest.mock('@auth-service/elasticsearch');
