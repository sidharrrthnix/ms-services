import { Create } from '@gateway-service/controllers/users/seller/create';
import { Get } from '@gateway-service/controllers/users/seller/get';
import { SellerSeed } from '@gateway-service/controllers/users/seller/seed';
import { Update } from '@gateway-service/controllers/users/seller/update';
